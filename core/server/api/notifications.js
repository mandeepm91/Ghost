...
notifications = {
            ...
            return _private.fetchAllNotifications()
                .then((allNotifications) => {
                    notificationsToCheck.forEach((notification) => {
                        let isDuplicate = allNotifications.find((n) => {
                    ...
                    let hasReleaseNotification = notificationsToCheck.find((notification) => {
                    ...
                    let addedReleaseNotifications = addedNotifications.filter((notification) => {
                        return !notification.custom;
                    });
    ...
    destroy: function destroy(options) {
        ...
        function destroyNotification(options) {
            return _private.fetchAllNotifications()
                .then((allNotifications) => {
                    let notificationToMarkAsSeen = allNotifications.find((notification) => {
